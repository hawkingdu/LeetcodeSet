...
public class DesignLinkedList707 {
    ...
    public static void main(String[] args) {
        DesignLinkedList707 linkedList707 = new DesignLinkedList707();
        linkedList707.addAtHead(1);
        linkedList707.addAtTail(2);
        linkedList707.addAtIndex(0,3);
        DesignLinkedList707.print(linkedList707.head);
